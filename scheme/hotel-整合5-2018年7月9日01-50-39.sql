...
(3,20,10,'2018-07-05',4,'2018-07-09','null',3,110,333),
(6,2,4,'2018-07-01',4,'2018-07-05','dinner',3,0,0),
(7,4,5,'2018-07-19',4,'2018-07-11','dinner',3,0,0),
(8,15,21,'2018-07-12',4,'2018-07-11','dinner',1,0,0);
...
(16,'R1-5','大床',35,2,1000,NULL,NULL,NULL,NULL,0),
...
(25,'R4-2','优惠房',1,25,300,NULL,NULL,NULL,NULL,0);
...
(1002,'admin','123456',10,'manager','2018-07-08 20:16:49','0:0:0:0:0:0:0:1'),
...
BEGIN
     ...
     SET id_exist=(SELECT check_room_id FROM `checklist` WHERE checkRoomId=check_room_id);
