...
(1006,'Joe','test',10,'test','2018-07-06 23:53:27',NULL);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_guestDel`(IN guestName VARCHAR(10), OUT state VARCHAR(30))
BEGIN
     DECLARE id_exist SMALLINT;
