						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<a class="panel-title list-group-item collapsed active"
									data-toggle="collapse" data-parent="#panel-User"
									href="#panel-element-useradd">增加用戶信息</a>
							</div>
							<!-- 新增用戶 -->
							<div id="panel-element-useradd" class="panel-collapse collapse">
								<form
									...
									<div class="list-group-item">
										密码<input name="password" type="password" class="allInput"
											value="${password}" />
									</div>
						...
						<div class="panel panel-default">
							...
							<div id="panel-element-8" class="panel-collapse collapse in">
								<form action="UserServlet?method=update" method="post">
									...
									<div class="list-group-item">
										积分<input name="credits" value="${updateUser.getCredits() }">
									</div>
									<div class="list-group-item">
